...
namespace Streetcode.XUnitTest.MediatRTests.Sources.SourceLinkCategory
{
    public class GetAllCategoriesHandlerTests
    {
        ...
        public GetAllCategoriesHandlerTests()
        {
            ...
            _handler = new GetAllCategoriesHandler(_repositoryWrapperMock.Object, _mapperMock.Object, _blobServiceMock.Object, _loggerMock.Object);
        }
        ...
        public async Task Handle_ReturnOkResult_WhenSourceLinkCategoriesExist()
        {
            ...
            var sourceLinkCategories = new List<SrcLinkCategory> { new SrcLinkCategory { Id = 1, Title = "Link Title", ImageId = 1, Image = image } };
            var mappedCategories = new List<SourceLinkCategoryDto> { new SourceLinkCategoryDto { Id = 1, Title = "Link Title", ImageId = 1, Image = imageDto } };
        ...
        public async Task Handle_ReturnsFailResult_WhenCategoriesAreNull()
        {
            ...
            _loggerMock.Verify(logger => logger.LogError(It.IsAny<GetAllCategoriesQuery>(), "Categories is null"), Times.Once);
        }
    }
}
